...
# model_wd = "tests/model_options" # where to save models nested within wd
...
mig_epoch = int(sys.argv[8]) # one or two epochs of migration for Wild -> TV
...
Mig_WildTV2_param = """
- name: {Mig_WildTV2}
  description: migration rate between TV and Wild epoch 2
  values:
  - migrations:
      0: rate
  upper_bound: {Mig_WildTV2_upper}
  lower_bound: {Mig_WildTV2_lower}""".format(Mig_WildTV2=Mig_WildTV2, Mig_WildTV2_upper=Mig_WildTV2_upper, Mig_WildTV2_lower=Mig_WildTV2_lower)
Mig_TVWild_param = """
- name: {Mig_TVWild}
...
Tmig_WildTV2_param = """
- name: {Tmig_WildTV2}
  description: migration time between TV and Wild epoch 2
  values:
  - migrations:
      0: start_time
  upper_bound: {Tmig_WildTV2_upper}
  lower_bound: {Tmig_WildTV2_lower}""".format(Tmig_WildTV2=Tmig_WildTV2, Tmig_WildTV2_upper=Tmig_WildTV2_upper, Tmig_WildTV2_lower=Tmig_WildTV2_lower)
Tmig_TVWild_param = """
- name: {Tmig_TVWild}
  description: migration time between TV and Wild
  values:
...
Tmig_WildTV2_constraint = """
- params: [{Tmig_WildTV}, {Tmig_WildTV2}]
  constraint: greater_than""".format(Tmig_WildTV=Tmig_WildTV, Tmig_WildTV2=Tmig_WildTV2)
...
if model == "no_mig":
    ...
    if mig_epoch == 2:
        mig_constraints = mig_constraints + Tmig_WildTV2_constraint
        mig_params = mig_params + Tmig_WildTV2_param + Mig_WildTV2_param
elif model == "bi_mig":
...
file_name = str(model + "_" + complexity + "_" + ancient_exp + "_" + shelf + "_" + TV_exp + "_" + "TV_" + selfing + "_WildAnc_" + selfing_all + "_migepoch_" + str(mig_epoch) + "_options.yaml")
