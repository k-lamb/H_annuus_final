...
# # home system
# wd = "/Users/kericlamb/Documents/Work MacBook/Research/paper_code/H_annuus_demography/Hannuus_moments3_og/code/moments_scripts" # upper level directory
...
pulse = sys.argv[9] # pulse or none
...
if template == True:
    file_name = str(model + "_" + complexity + "_" + ancient_exp + "_" + shelf + "_" + TV_exp + "_" + "TV_" + selfing + "_WildAnc_" + selfing_all + "_admix_" + str(pulse) + "_template.yaml")
elif template == False:
    file_name = str(model + "_" + complexity + "_" + ancient_exp + "_" + shelf + "_" + TV_exp + "_" + "TV_" + selfing + "_WildAnc_" + selfing_all + "_admix_" + str(pulse) + "_model.yaml")
...
generation_time: 1
demes:
""".format(model + " + " + complexity + " + " + ancient_exp + " + " + shelf + " + " + TV_exp + " + TV " + selfing + " + WildAnc " + selfing_all + " + admix " + pulse)
...
pulses:
  - sources: [Wild]
    dest: TV
    proportions: [{pulse_WildTV}]
    time: {Tpulse_WildTV}""".format(pulse_WildTV=pulse_WildTV, Tpulse_WildTV=Tpulse_WildTV)
elif pulse == "none":
    pulse_admix = """"""
