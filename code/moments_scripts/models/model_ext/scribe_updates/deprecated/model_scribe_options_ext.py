...
# home system
wd = "/Users/kericlamb/Documents/Work MacBook/Research/paper_code/H_annuus_demography/H_annuus_final/code/moments_scripts/models/" # upper level directory


sys.path.append(wd)
from options_bounds_config_ext import *
...
TV_exp = sys.argv[5] # TV_exp, TV_noexp, TV_bottle, or TV_exp_con
...
- name: {Ncon2_TV}
  ...
  - demes:
      TV:
        epochs:
          {{0}}: end_size
  upper_bound: {Ncon2_TV_upper}
  lower_bound: {Ncon2_TV_lower}""".format(Ncon2_TV=Ncon2_TV, Ncon2_TV_upper=Ncon2_TV_upper, Ncon2_TV_lower=Ncon2_TV_lower)
self_TV0_rate_param = """
- name: {self_TV0_rate}
...
- name: {self_TV3_rate}
  ...
  - demes:
      TV:
        epochs:
          3: selfing_rate
  upper_bound: {self_TV3_rate_upper}
  lower_bound: {self_TV3_rate_lower}""".format(self_TV3_rate=self_TV3_rate, self_TV3_rate_upper=self_TV3_rate_upper, self_TV3_rate_lower=self_TV3_rate_lower)
Nmodcon_TV_param = """
- name: {Nmodcon_TV}
  description: modern TV Ne after minor contraction
  values:
  - demes:
      TV:
        epochs:
          {{0}}: end_size
  upper_bound: {Nmodcon_TV_upper}
  lower_bound: {Nmodcon_TV_lower}""".format(Nmodcon_TV=Nmodcon_TV, Nmodcon_TV_upper=Nmodcon_TV_upper, Nmodcon_TV_lower=Nmodcon_TV_lower)
Tmodcon_TV_param = """
- name: {Tmodcon_TV}
  description: time when expansion ends and con1 begins
  values:
  - demes:
      TV:
        epochs:
          {{0}}: end_time
  upper_bound: {Tmodcon_TV_upper}
  lower_bound: {Tmodcon_TV_lower}""".format(Tmodcon_TV=Tmodcon_TV, Tmodcon_TV_upper=Tmodcon_TV_upper, Tmodcon_TV_lower=Tmodcon_TV_lower)
...
Tbottle_TV_constraint = """
- params: [{Tfinal_anc}, {Texp_TV}]
  constraint: greater_than""".format(Tfinal_anc=Tfinal_anc, Texp_TV=Texp_TV)
Tbottle_shelf_TV_constraint = """
- params: [{Tshelf_TV}, {Texp_TV}]
  constraint: greater_than""".format(Tshelf_TV=Tshelf_TV, Texp_TV=Texp_TV)
Tmodcon_TV_constraint = """
- params: [{Texp_TV}, {Tmodcon_TV}]
  constraint: greater_than""".format(Texp_TV=Texp_TV, Tmodcon_TV=Tmodcon_TV)
...
if TV_exp == "TV_noexp":
    ...
    if shelf == "noshelf":
        ...
        TV_params = "{0}{1}{2}{3}".format(Tshelf_TV_param, N0_TV_param, Nshelf_TV_param, self_TV0_rate_param if selfing == "self" else "") # epoch 0
        TV_params = "{0}{1}{2}{3}".format(TV_params, Texp_TV_param.format("1"), Ncon_TV_param.format("1"), self_TV1_rate_param if selfing == "self" else "") # epoch 1
...
if TV_exp == "TV_bottle":
    if shelf == "noshelf":
        TV_params = "{0}{1}{2}{3}".format(Texp_TV_param.format("0"), N0_TV_param, Ncon_TV_param.format("0"), self_TV0_rate_param if selfing == "self" else "") # epoch 0
        TV_params = "{0}{1}{2}".format(TV_params, Ncon_TV_param.format("0"), self_TV1_rate_param if selfing == "self" else "") # epoch 1
        TV_constraints = Tbottle_TV_constraint
    elif shelf == "shelf":
        TV_params = "{0}{1}{2}{3}".format(Tshelf_TV_param, N0_TV_param, Nshelf_TV_param, self_TV0_rate_param if selfing == "self" else "") # epoch 0
        TV_params = "{0}{1}{2}".format(TV_params, Texp_TV_param.format("1"), Ncon_TV_param.format("1"), self_TV1_rate_param if selfing == "self" else "")  # epoch 1
        TV_params = "{0}{1}{2}".format(TV_params, Ncon2_TV_param.format("2"), self_TV2_rate_param if selfing == "self" else "")  # epoch 2
        TV_constraints = Tshelf_TV_constraint + Tbottle_shelf_TV_constraint
elif TV_exp == "TV_exp_con":
    if shelf == "noshelf":
        TV_params = "{0}{1}{2}{3}".format(Tcon_exp_TV_param, N0_TV_param, Ncon_TV_param.format("0"), self_TV0_rate_param if selfing == "self" else "") # epoch 0
        TV_params = "{0}{1}{2}".format(TV_params, Tmodcon_TV_param.format("1"), Nexp_TV_param.format("1"), self_TV1_rate_param if selfing == "self" else "") # epoch 1
        TV_params = "{0}{1}{2}".format(TV_params, Nmodcon_TV_param.format("2"), self_TV2_rate_param if selfing == "self" else "") # epoch 2
        TV_constraints = Tcon_exp_TV_constraint + Tmodcon_TV_constraint
    elif shelf == "shelf":
        TV_params = "{0}{1}{2}{3}".format(Tshelf_TV_param, N0_TV_param, Nshelf_TV_param, self_TV0_rate_param if selfing == "self" else "") # epoch 0
        TV_params = "{0}{1}{2}{3}".format(TV_params, Texp_TV_param.format("1"), Ncon_TV_param.format("1"), self_TV1_rate_param if selfing == "self" else "") # epoch 1
        TV_params = "{0}{1}{2}".format(TV_params, Tmodcon_TV_param.format("2"), Nexp_TV_param.format("2"), self_TV2_rate_param if selfing == "self" else "") # epoch 2
        TV_params = "{0}{1}{2}".format(TV_params, Nmodcon_TV_param.format("3"), self_TV3_rate_param if selfing == "self" else "") # epoch 3
        TV_constraints = Tshelf_TV_constraint + Texp_TV_constraint + Tmodcon_TV_constraint
...
file_name = str(model + "_" + complexity + "_" + ancient_exp + "_" + shelf + "_" + TV_exp + "_" + "TV_" + selfing + "_WildAnc_" + selfing_all + "_options.yaml")
